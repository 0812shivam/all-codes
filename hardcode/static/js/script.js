...
$(document).ready(function () {
  function processAndTranslateImage() {
    ...
    // Create FormData object and append the input image file
    setTimeout(function() {
      // Create FormData object and append the input image file
      ...
      // Set the image preview source to the dummy image path
      const imgElement = document.getElementById("image-preview1");
      imgElement.src = "static/images/dummy_output.jpeg";
      console.log("Image preview updated with processed image");

      // Hide the loading timer after the delay
...
function startLoadingTimer() {
  ...
  }, 1000000); // Check every 100 milliseconds
  ...
  }, 6000000); // Timeout after 60 seconds (adjust as needed)
}
...
//dummy_output audio
document.getElementById('tbtnnn').addEventListener('click', function () {
  var audioSource = document.getElementById('audioSource');
  var audioFilePath = 'static/audio/trans.mp3'; // Provide the path to your audio file here
  audioSource.src = audioFilePath;
  var audio = document.getElementById('outputAudio');
  audio.load(); // This reloads the audio element with the new source
});
